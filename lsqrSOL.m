function [ x, istop, itn, r1norm, r2norm, Anorm, Acond, Arnorm, xnorm, var ]...
   = lsqrSOL( m, n, A, b, damp, atol, btol, xtol, conlim, itnlim, show )
...
%-----------------------------------------------------------------------
% Modified by Joao M Pereira to add stopping condition as in equation (26)
% of HIPNEX paper
...
% Allow for tolerances set by the user.
  ...
  if  rnorm <= xtol * xnorm,  istop = 8; end
